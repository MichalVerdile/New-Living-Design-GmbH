...
async function checkOpenings(
  ...
  const question =
    ...
    'Set shower_floor_after to what the floor inside the shower of image 2 is: "tray" for a shower tray, one smooth piece without tile joints, even when it is level with the floor; "tiles" when the floor tiles continue into the shower; "none" when there is no shower or you cannot see its floor. ' +
