...
function buildPrompt(v: {
  ...
  const washbasinTapsIntro = v.washbasinTapsImageNumber
    ? ` Image ${v.washbasinTapsImageNumber} is ONLY a product photo of the Treemme Aurelia washbasin wall mixer on a plain white background, in chrome: ONE flat rectangular wall plate, wider than it is high, carrying both the spout and the lever; a slim spout with a flat top that bends down at its end; and a flat paddle lever that hangs down from a rounded base. Copy that exact shape for the washbasin mixer and nothing else from it; in the result its finish is the one named under CHANGE next to image ${v.washbasinTapsImageNumber}, not necessarily chrome. The image contains no room, no wall and no layout.`
    : '';
  const showerTapsIntro = v.showerTapsImageNumber
    ? ` Image ${v.showerTapsImageNumber} is ONLY a product photo of the Treemme Aurelia shower set on a plain white background, in chrome: TWO round wall plates that carry the controls, the mixer with its flat paddle lever and the diverter with its round knob; a separate, smaller round wall outlet for the hose; a slim stick hand shower in its holder whose UPPER part carries a finely fluted, knurled band just below the round spray face while the rest of the rod is plain; and a round overhead shower on a flat wall arm, its shell finely fluted around the rim. Copy their exact shapes for the shower fittings and nothing else from it; in the result their finish is the one named under CHANGE next to image ${v.showerTapsImageNumber}, not necessarily chrome. The image contains no room, no wall and no layout.`
    : '';
    ...
    ? 'Look at the washbasin mixer in image 2. Set washbasin_tap_plate to the shape of the plate or body it sits on at the wall: "rectangular", "round", "none" or "unknown". Answer "none" only when there is no mixer at the washbasin at all; a mixer that is partly hidden behind the basin, seen at a sharp angle or simply small in the picture is still there, then answer the shape you can see or "unknown". '
      ...
      + (wanted.shower
        ? 'Look at the shower fittings in image 2. Set shower_rosette_count to the number of separate round wall plates that carry the shower CONTROLS, as a number; do not count the round wall outlet the hose comes out of and do not count the wall arm of the overhead shower. '
          ...
          + 'Set shower_handset_grip to "ribbed" when ANY part of the hand shower handle has fine grooves or knurling, even a short band, "smooth" when the whole handle is plain, "other" or "unknown". '
        : '')
    : '';
  const question =
