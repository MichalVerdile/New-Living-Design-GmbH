        ...
        <div className={styles["hero-container"]}>
          <div className={styles["hero-content"]}>
            ...
            <p className={styles["hero-subtitle"]}>
              ...
              praktische Erfahrung aus Umbau und Plattenarbeiten mit der Auswahl für den ganzen Raum.
            </p>
          </div>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.grid}>
            <article className={styles.card}>
              ...
              <p>
                Unsere Erfahrung kommt aus der Arbeit mit Oberflächen, Formaten und ihrer sauberen Verarbeitung.
            ...
            <article className={styles.card}>
              ...
              <p>
                ...
                Platten, Möbel, Armaturen und Farben nebeneinander sehen, anfassen und vergleichen.
              </p>
            </article>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.facts}>
            ...
            <div className={styles.fact}>
              ...
              <div className={styles["fact-content"]}>
                <h4>Zofingen (AG)</h4>
                <p>Materialien und Produkte direkt miteinander vergleichen.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.values}>
            ...
            <div className={styles["value-item"]}>
              ...
              <p>Wir betrachten Proportionen, Anschlüsse, Farben und die Produkte daneben.</p>
            </div>
            ...
            <div className={styles["value-item"]}>
              ...
              <p>Produkte, Leistungen und Zuständigkeiten werden vor Bestellung oder Ausführung beschrieben.</p>
            </div>
          </div>
        </div>
      </section>
