...
const steps = [
  ...
  { n: '3', title: 'Planung und verbindliche Offerte', text: 'Sie erhalten die abgestimmte Auswahl, je nach Paket eine 3D-Visualisierung und eine Offerte mit klarem Leistungsumfang.' },
  { n: '4', title: 'Termine und Ausführung', text: 'Wir bestellen die bestätigten Produkte und koordinieren die vereinbarten Facharbeiten in der richtigen Reihenfolge.' },
      ...
      <section className={styles.hero}>
        ...
        <div className={`${styles.heroContent} ${isVisible ? styles.visible : ''}`}>
          ...
          <p className={styles.heroText}>
            ...
            vereinbarte Lösung und koordinieren die nötigen Facharbeiten. Drei Pakete geben Ihnen eine erste
            Preisorientierung ab CHF {bathPackages[0].priceLabel}; den Fixpreis erhalten Sie nach der Besichtigung.
          </p>
        ...
        <div className={styles.container}>
          <div className={styles.sectionHeader}>
            ...
            <p className={styles.sectionIntro}>
              ...
              Masse und zusätzliche Arbeiten klären wir vor der verbindlichen Offerte.
            </p>
          </div>
      ...
      <section id="gebiet" className={`${styles.section} ${styles.dark}`}>
        <div className={styles.container}>
          ...
          <p className={styles.placesNote}>
            Wir arbeiten auch in den Gemeinden dazwischen. Senden Sie uns Ihre Postleitzahl; wir bestätigen,
            ob Ihr Projekt im Gebiet liegt und welche Konditionen für die Besichtigung gelten.
          </p>
        </div>
      </section>
            ...
            <div className={styles.formActions}>
              ...
              {status === 'error' && (
                <p className={styles.error}>
                  Die Anfrage konnte nicht gesendet werden. Rufen Sie uns an: <a href={`tel:${business.phone.e164}`} data-lead="badumbau-fehler">{business.phone.display}</a>
                </p>
              )}
            </div>
